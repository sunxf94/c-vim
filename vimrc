...
" BlogPost: https://blog.csdn.net/snowin1994
" ReadMe: README.md
...
autocmd FileType python,php,golang set tabstop=4 shiftwidth=4 expandtab ai
...
" 修复YouCompleteMe在one主题下颜色问题
highlight PMenu ctermfg=249 ctermbg=237 guifg=black guibg=darkgrey
highlight PMenuSel ctermfg=249 ctermbg=8 guifg=darkgrey guibg=black
hi Normal ctermfg=grey ctermbg=233
